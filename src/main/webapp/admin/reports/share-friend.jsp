...
<head>
  ...
  <link rel="stylesheet" href='<c:url value="/plugins/datatables-responsive/css/responsive.bootstrap4.min.css"/>' type="text/css">
  <link rel="stylesheet" href='<c:url value="/plugins/datatables-buttons/css/buttons.bootstrap4.min.css"/>'type="text/css">
  <!-- Theme style -->
               ...
               <li class="nav-item menu-open">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                      <li class="nav-item">
                        <a href="video-edition.html" class="nav-link">
                          <i class="far fa-circle nav-icon"></i>
                          <p>Video Edition</p>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="video-list.html" class="nav-link">
                          <i class="far fa-circle nav-icon"></i>
                          <p>Video List</p>
                        </a>
                      </li>
                  ...
                  <li class="nav-item ">
                    ...
                    <ul class="nav nav-treeview">
                      <li class="nav-item">
                        <a href="user-edition.html" class="nav-link">
                          <i class="far fa-circle nav-icon"></i>
                          <p>User Edition</p>
                        </a>
                      </li>
                  ...
                  <li class="nav-item menu-open">
                    ...
                    <ul class="nav nav-treeview">
                      ...
                      <li class="nav-item">
                        <a href="favorites-user.html" class="nav-link">
                          <i class="far fa-circle nav-icon"></i>
                          <p>Favorite Users</p>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a href="share-friend.html" class="nav-link active">
                          <i class="far fa-circle nav-icon"></i>
                          <p>Share Friends</p>
                        </a>
                      </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Share Friends Information</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Share Friends Information</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Share Friends Information</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
